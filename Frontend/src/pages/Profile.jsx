...
const response = await axios.get(
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-green-50 via-white to-emerald-50 py-8 px-4 sm:py-12 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-linear-to-r from-green-500 to-emerald-600 px-6 sm:px-8 py-12">
              ...
              {isEditing ? (
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button
                    ...
                    className="flex-1 px-6 py-3.5 bg-linear-to-r from-green-600 to-green-700 text-white font-semibold rounded-xl hover:from-green-700 hover:to-green-800 transition-all duration-200 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
